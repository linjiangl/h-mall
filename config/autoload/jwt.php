...
return [
    ...
    'secret' => env('JWT_SECRET', 'U2FsdGVkX1+5a0PASn7USXRvQm71'), // 非对称加密使用字符串,请使用自己加密的字符串
    ...
    'ttl' => env('JWT_TTL', 86400 * 15), // token过期时间，单位为秒
    ...
    'blacklist_prefix' => 'blacklist_jwt', // 黑名单缓存的前缀
    ...
    'scene' => [
        'default' => [],
        'admin' => [
            'secret' => 'U2FsdGVkX1/Yrvu0ss0KUQ8PnCWGdSEQ', // 非对称加密使用字符串,请使用自己加密的字符串
