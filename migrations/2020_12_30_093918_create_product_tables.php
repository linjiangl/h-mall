...
class CreateProductTables extends Migration
{
    ...
    public function up(): void
    {
        ...
        \Hyperf\DbConnection\Db::statement("ALTER TABLE `brand` COMMENT '商品品牌'");
        \Hyperf\DbConnection\Db::statement("ALTER TABLE `category` COMMENT '商品分类'");
        \Hyperf\DbConnection\Db::statement("ALTER TABLE `category_spec` COMMENT '商品分类-关联的商品规格'");
        \Hyperf\DbConnection\Db::statement("ALTER TABLE `product` COMMENT '商品'");
        \Hyperf\DbConnection\Db::statement("ALTER TABLE `product_spec` COMMENT '商品规格项'");
        \Hyperf\DbConnection\Db::statement("ALTER TABLE `product_sku` COMMENT '商品规格'");
        \Hyperf\DbConnection\Db::statement("ALTER TABLE `product_sku_spec_value` COMMENT '商品规格值'");
        \Hyperf\DbConnection\Db::statement("ALTER TABLE `product_parameter` COMMENT '商品参数'");
