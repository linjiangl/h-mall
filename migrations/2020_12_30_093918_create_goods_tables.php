...
class CreateGoodsTables extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('goods', function (Blueprint $table) {
            ...
            $table->integer('category_id', false, true)->comment('所属分类');
            $table->integer('brand_id', false, true)->default(0)->comment('品牌');
            $table->integer('sku_id', false, true)->default(0);
            ...
            $table->integer('stock', false, true)->default(0)->comment('商品库存（总和）');
            $table->integer('stock_alarm', false, true)->default(0)->comment('库存预警');
            ...
            $table->tinyInteger('status')->default(0)->comment('状态 -1:已删除 0:仓库中, 1:销售中');
